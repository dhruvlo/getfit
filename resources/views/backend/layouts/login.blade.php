...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('back/vendor/fontawesome-free/css/all.min.css')}}">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('back/css/sb-admin-2.min.css')}}">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="{{ route('admin_dashboard') }}" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
